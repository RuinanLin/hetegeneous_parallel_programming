// This file is used to play '__device__'
...
// The func with __device__ is the func that callable on device and executed on device
__device__
void vecAddKernelDeviceFunc(float *A, float *B, float *C, int n, int i)
{
    if (i < n)
        C[i] = A[i] + B[i];
}
...
void vecAddKernel(float *A, float *B, float *C, int n)
{
    ...
    vecAddKernelDeviceFunc(A, B, C, n, i);
}
